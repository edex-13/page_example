...
const FeaturesNormaCheck: React.FC = () => {
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-2 md:grid-cols-2 sm:grid-cols-1 xs:grid-cols-1 gap-8">
          <div className="col-span-1 flex flex-col items-center justify-center animate-reveal">
            <img src="/flow_norma_check.png" alt="NormaCheck Flow" className="min-w-[300px] max-w-[350px] object-cover" width={1000} height={1000} />
          </div>
          <div className="col-span-1 flex flex-col items-center justify-start md:max-w-[550px]">
            <h2 className="text-2xl font-bold mb-3 text-powble-white">Normacheck can boost your design process through project assessment and ticket generation in least of one minute</h2>
            <div className="list-disc list-inside flex flex-col gap-2 justify-start items-start w-full">
              <div className={containerStyle}>
                ...
                <div className={contentStyle}>
                  ...
                  <p className={descriptionStyle}>Normacheck will assess your project and generate a list of tickets based on the project requirements.</p>
                </div>
              </div>
              ...
              <div className={containerStyle}>
                ...
                <div className={contentStyle}>
                  ...
                  <p className={descriptionStyle}>Normacheck will generate a list of tickets based on the project requirements.</p>
                </div>
              </div>
              ...
              <div className={containerStyle}>
                ...
                <div className={contentStyle}>
                  ...
                  <p className={descriptionStyle}>Normacheck will generate a response to the ticket based on the project requirements.</p>
                </div>
              </div>
...
export default FeaturesNormaCheck;
